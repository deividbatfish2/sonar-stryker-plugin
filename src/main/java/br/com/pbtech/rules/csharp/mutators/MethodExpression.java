...
public class MethodExpression implements RulesDefinition {

    public static final RuleKey METHOD_EXPRESSION = RuleKey.of(REPOSITORY_KEY_CS, "stryker.rule.cs.method_expression");
