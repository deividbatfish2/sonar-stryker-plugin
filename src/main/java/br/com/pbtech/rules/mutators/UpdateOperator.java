...
public class UpdateOperator implements RulesDefinition {

    public static final RuleKey UPDATE_OPERATOR_JS = RuleKey.of(REPOSITORY_KEY_JS, "stryker.rule.js.update_operator");
    public static final RuleKey UPDATE_OPERATOR_CS = RuleKey.of(REPOSITORY_KEY_CS, "stryker.rule.cs.update_operator");
