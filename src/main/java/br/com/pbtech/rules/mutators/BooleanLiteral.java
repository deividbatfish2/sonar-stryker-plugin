...
public class BooleanLiteral implements RulesDefinition {

    public static final RuleKey BOOLEAN_LITERAL_JS = RuleKey.of(REPOSITORY_KEY_JS, "stryker.rule.js.boolean_literal");
    public static final RuleKey BOOLEAN_LITERAL_CS = RuleKey.of(REPOSITORY_KEY_CS, "stryker.rule.cs.boolean_literal");
